...
\begin{frame}
  ...
  Aspects \ldots
  \begin{itemize}
    \item<2-> referentially transparent \lstinputlisting[firstline=2, lastline=3, showstringspaces=false]{scala/ReferentialTransparency.scala}
...
\begin{frame}[fragile]
  ...
  \uncover<2->{
    ...
    \lstinputlisting[firstline=2, lastline=6, showstringspaces=false]{scala/NonRecursive.scala}
  }
  \uncover<3>{
    With recursion \ldots
    \lstinputlisting[firstline=2, lastline=5, showstringspaces=false]{scala/Recursion.scala}
  }
\end{frame}

\begin{frame}
  \frametitle{Pattern matching}
  \lstinputlisting[firstline=2, lastline=11, showstringspaces=false]{scala/PatternMatching.scala}
\end{frame}

\begin{frame}[fragile]
  \frametitle{First class functions}
  Pass around functions like variables
  \lstinputlisting[firstline=2, lastline=6]{scala/FirstClassFunctions.scala}
...
\begin{frame}[fragile]
  ...
  \lstinputlisting[firstline=4, lastline=11]{scala/HigherOrderFunctions.scala}
\end{frame}
...
\begin{frame}[fragile]
  ...
  \lstinputlisting[firstline=4, lastline=15]{scala/FunctionalClassVSObject.scala}
\end{frame}
